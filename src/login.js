...
function Login(){
    ...
    return(
        <div className='full-height'>
            <div id='header' className='loginheader'>Express Raid</div>
                ...
                <div id='login' className='popup'>
                    <div id='popupwindow' className='popupwindow' style={popupwindowstyle} >
                        ...
                        <div className='loginstyle2'>
                            ...
                            <div style={space}></div>
                            <div style={space}></div>
                            <div> <label className='linklabel' onClick={registration}>Join us now!</label></div>
                            <div><label className='linklabel' onClick={registration}>Forget Password</label></div>
                        </div>
                    </div>
                </div>
